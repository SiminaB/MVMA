...
setwd("/data/bocasm/Research/Meta analysis/code/simulations/cost_of_estimation_bd_het")
...
##added August 2016: also save Bayesian estimates
...
save(list=c("MSEs", "Vars",
     ...
     "OverallEstSigmaUniv"),
     file=paste("simResultsComb/combine_cost_of_estimation_bd_het_",rowNr,".RData", sep=""))
