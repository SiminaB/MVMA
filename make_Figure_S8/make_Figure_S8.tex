...
\section{Get results to make panels a) and b)}
...
\hlstd{\{}
    ...
    \hlstd{\{}
      \hlstd{VarsAll[rowNr,} \hlkwd{colnames}\hlstd{(Vars)]} \hlkwb{<-} \hlstd{Vars[rowNr,} \hlkwd{colnames}\hlstd{(Vars)]}
    \hlstd{\}}
\hlstd{\}}
...
\begin{alltt}
\hlstd{allFiles} \hlkwb{<-} \hlkwd{list.files}\hlstd{(}\hlstr{"simResultsComb"}\hlstd{)}
\hlcom{##keep only files with "Suppl_Bayes" in title}
\hlstd{allFiles} \hlkwb{<-} \hlstd{allFiles[}\hlkwd{grep}\hlstd{(}\hlstr{"Suppl_Bayes"}\hlstd{, allFiles)]}
...
\hlstd{\{}
    ...
    \hlstd{rowNr} \hlkwb{<-} \hlkwd{gsub}\hlstd{(}\hlstr{"combine_cost_of_estimation_Suppl_Bayes"}\hlstd{,} \hlstr{""}\hlstd{, allFiles[file])}
    \hlstd{rowNr} \hlkwb{<-} \hlkwd{gsub}\hlstd{(}\hlstr{".RData"}\hlstd{,} \hlstr{""}\hlstd{, rowNr)}
    \hlstd{rowNr} \hlkwb{<-} \hlkwd{as.numeric}\hlstd{(rowNr)}
...
\end{alltt}
\begin{verbatim}
## [1] 0.9370509 0.9996242
\end{verbatim}
\end{kframe}
\end{knitrout}

Get what is needed for panels a) and b):
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{Vars.b} \hlkwb{<-} \hlstd{VarsAll}

\hlcom{##add in the 0 heterogeneity case}
\hlstd{Vars.b} \hlkwb{<-} \hlkwd{rbind}\hlstd{(Vars.b, Vars0)}
...
\section{Create plots a) and b)}

Panel a):
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{panelA} \hlkwb{<-} \hlkwd{ggplot}\hlstd{(RelEff.c,} \hlkwd{aes}\hlstd{(}\hlkwc{x}\hlstd{=p,} \hlkwc{y}\hlstd{=RelEff))}\hlopt{+}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{panelB} \hlkwb{<-} \hlkwd{ggplot}\hlstd{(RelEff.c,} \hlkwd{aes}\hlstd{(}\hlkwc{x}\hlstd{=p,} \hlkwc{y}\hlstd{=MVMAcomp))}\hlopt{+}
  \hlkwd{geom_point}\hlstd{(}\hlkwc{size}\hlstd{=}\hlnum{3.0}\hlstd{,} \hlkwd{aes}\hlstd{(}\hlkwc{color}\hlstd{=}\hlkwd{as.factor}\hlstd{(varBtw),} \hlkwc{shape}\hlstd{=}\hlkwd{as.factor}\hlstd{(varBtw)))}\hlopt{+}
  ...
  \hlkwd{ylim}\hlstd{(}\hlkwd{min}\hlstd{(RelEff.c}\hlopt{$}\hlstd{MVMAcomp)}\hlopt{*}\hlnum{0.8}\hlstd{,} \hlnum{1.2}\hlstd{)} \hlopt{+}
  \hlkwd{labs}\hlstd{(}\hlkwc{color}\hlstd{=}\hlstr{""}\hlstd{,} \hlkwc{shape}\hlstd{=}\hlstr{""}\hlstd{,}
...
\section{Get results to make panels c) and d)}
...
\begin{alltt}
\hlstd{allFiles} \hlkwb{<-} \hlkwd{list.files}\hlstd{(}\hlstr{"simResultsComb"}\hlstd{)}
\hlcom{##remove files with "Suppl_Bayes" in title}
\hlstd{allFiles} \hlkwb{<-} \hlstd{allFiles[}\hlopt{-}\hlkwd{grep}\hlstd{(}\hlstr{"Suppl_Bayes"}\hlstd{, allFiles)]}
...
\hlstd{panelC} \hlkwb{<-} \hlkwd{ggplot}\hlstd{(RelEff.c,} \hlkwd{aes}\hlstd{(}\hlkwc{x}\hlstd{=p,} \hlkwc{y}\hlstd{=RelEff))}\hlopt{+}
  ...
  \hlstd{themeUsed}\hlopt{+}
  \hlkwd{ylab}\hlstd{(}\hlkwd{expression}\hlstd{(RelEff))} \hlopt{+}
  \hlkwd{ylim}\hlstd{(}\hlkwd{min}\hlstd{(RelEff.c}\hlopt{$}\hlstd{RelEff)}\hlopt{*}\hlnum{0.8}\hlstd{,} \hlnum{1}\hlstd{)} \hlopt{+}
  \hlkwd{labs}\hlstd{(}\hlkwc{color}\hlstd{=}\hlstr{""}\hlstd{,} \hlkwc{shape}\hlstd{=}\hlstr{""}\hlstd{,}
