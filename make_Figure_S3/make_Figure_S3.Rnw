...
panelB <- ggplot(Vars.a, aes(x=p, y=Ratio))+
...
Panel a): 
<<Figure_S3_panel_a, fig.width=6, fig.height=5, dpi=800>>=
panelA <- ggplot(Vars.b, aes(x=p, y=Ratio))+
  ...
  scale_color_manual(values=gg_color_hue(4)[-1],
                     name = "",
                     labels = 
...
panelC <- ggplot(Vars.c, aes(x=p, y=Ratio))+
  ...
  scale_color_manual(values=gg_color_hue(4)[-1],
                     name = "",
                       labels = 
                         c(expression(paste(sigma^2, phantom() %~~% phantom(),
                                            1/5)),
                           expression(paste(sigma^2, phantom() %~~% phantom(),
                                            1)),
                           expression(paste(sigma^2, phantom() %~~% phantom(),
                                            5)))) +
  scale_shape_manual(values=c(17,15,3),
