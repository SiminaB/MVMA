...
<<Figure_S5_panel_a, fig.width=6, fig.height=5, dpi=800>>=
...
Panel b):
<<Figure_S5_panel_b, fig.width=6, fig.height=5, dpi=800>>=
...
Panel c):
<<Figure_S5_panel_c, fig.width=6, fig.height=5, dpi=800>>=
...
Panel d):
<<Figure_S5_panel_d, fig.width=6, fig.height=5, dpi=800>>=
...
<<Figure_S5_panels_abcd, fig.width=12, fig.height=12, dpi=800>>=
