...
\hlcom{##remove files that have "bd_het" in the title}
\hlstd{allFiles} \hlkwb{<-} \hlstd{allFiles[}\hlopt{-}\hlkwd{grep}\hlstd{(}\hlstr{"bd_het"}\hlstd{, allFiles)]}
...
\begin{alltt}
\hlstd{allFiles} \hlkwb{<-} \hlkwd{list.files}\hlstd{(}\hlstr{"simResultsComb"}\hlstd{)}
\hlcom{##keep only files that have "bd_het" in the title}
\hlstd{allFiles} \hlkwb{<-} \hlstd{allFiles[}\hlkwd{grep}\hlstd{(}\hlstr{"bd_het"}\hlstd{, allFiles)]}
...
\hlstd{\{}
    ...
    \hlstd{rowNr} \hlkwb{<-} \hlkwd{gsub}\hlstd{(}\hlstr{"combine_cost_of_estimation_bd_het_"}\hlstd{,} \hlstr{""}\hlstd{, allFiles[file])}
    \hlstd{rowNr} \hlkwb{<-} \hlkwd{gsub}\hlstd{(}\hlstr{".RData"}\hlstd{,} \hlstr{""}\hlstd{, rowNr)}
    \hlstd{rowNr} \hlkwb{<-} \hlkwd{as.numeric}\hlstd{(rowNr)}
...
\hlstd{RelEff.b} \hlkwb{<-}
  \hlkwd{rbind}\hlstd{(}\hlkwd{cbind}\hlstd{(}\hlkwd{as.matrix}\hlstd{(Vars[,}\hlkwd{c}\hlstd{(}\hlstr{"I"}\hlstd{,} \hlstr{"p"}\hlstd{,} \hlstr{"corrBtw"}\hlstd{,} \hlstr{"varBtw"}\hlstd{,} \hlstr{"RelEff"}\hlstd{,}\hlstr{"MVMAcomp"}\hlstd{),]),}\hlstr{"RelEff"}\hlstd{),}
        \hlkwd{cbind}\hlstd{(}\hlkwd{as.matrix}\hlstd{(Vars[,}\hlkwd{c}\hlstd{(}\hlstr{"I"}\hlstd{,} \hlstr{"p"}\hlstd{,} \hlstr{"corrBtw"}\hlstd{,} \hlstr{"varBtw"}\hlstd{,} \hlstr{"RelEffT"}\hlstd{,}\hlstr{"MVMAcomp"}\hlstd{),]),}\hlstr{"RelEffT"}\hlstd{),}
        \hlkwd{cbind}\hlstd{(}\hlkwd{as.matrix}\hlstd{(Vars[,}\hlkwd{c}\hlstd{(}\hlstr{"I"}\hlstd{,} \hlstr{"p"}\hlstd{,} \hlstr{"corrBtw"}\hlstd{,} \hlstr{"varBtw"}\hlstd{,} \hlstr{"RelEffB"}\hlstd{,} \hlstr{"MVMAcomp"}\hlstd{),]),}\hlstr{"RelEffB"}\hlstd{))}
\hlkwd{colnames}\hlstd{(RelEff.b)[}\hlkwd{ncol}\hlstd{(RelEff.b)]} \hlkwb{<-} \hlstr{"Estimate"}
...
\hlstd{RelEff.b}\hlopt{$}\hlstd{MVMAcomp} \hlkwb{<-} \hlkwd{as.numeric}\hlstd{(}\hlkwd{as.character}\hlstd{(RelEff.b}\hlopt{$}\hlstd{MVMAcomp))}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\hlstd{panelA} \hlkwb{<-} \hlkwd{ggplot}\hlstd{(RelEff.b,} \hlkwd{aes}\hlstd{(}\hlkwc{x}\hlstd{=p,} \hlkwc{y}\hlstd{=RelEff))}\hlopt{+}
  ...
  \hlkwd{scale_linetype_manual}\hlstd{(}\hlkwc{name} \hlstd{=} \hlstr{""}\hlstd{,}
                        ...
                        \hlkwc{values}\hlstd{=}\hlkwd{c}\hlstd{(}\hlnum{2}\hlstd{,}\hlnum{3}\hlstd{,}\hlnum{1}\hlstd{))}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{panelB} \hlkwb{<-} \hlkwd{ggplot}\hlstd{(RelEff.b,} \hlkwd{aes}\hlstd{(}\hlkwc{x}\hlstd{=p,} \hlkwc{y}\hlstd{=MVMAcomp))}\hlopt{+}
  \hlkwd{geom_point}\hlstd{(}\hlkwc{size}\hlstd{=}\hlnum{3.0}\hlstd{,} \hlkwd{aes}\hlstd{(}\hlkwc{color}\hlstd{=}\hlkwd{as.factor}\hlstd{(varBtw),} \hlkwc{shape}\hlstd{=}\hlkwd{as.factor}\hlstd{(varBtw)))}\hlopt{+}
  \hlkwd{geom_line}\hlstd{(}\hlkwd{aes}\hlstd{(}\hlkwc{color}\hlstd{=}\hlkwd{as.factor}\hlstd{(varBtw),} \hlkwc{shape}\hlstd{=}\hlkwd{as.factor}\hlstd{(varBtw)))}\hlopt{+}
  \hlstd{themeUsed}\hlopt{+}
  ...
  \hlkwd{ylim}\hlstd{(}\hlkwd{min}\hlstd{(RelEff.b}\hlopt{$}\hlstd{MVMAcomp)}\hlopt{*}\hlnum{0.8}\hlstd{,} \hlnum{1.2}\hlstd{)} \hlopt{+}
  \hlkwd{labs}\hlstd{(}\hlkwc{color}\hlstd{=}\hlstr{""}\hlstd{,} \hlkwc{shape}\hlstd{=}\hlstr{""}\hlstd{,}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{panelC} \hlkwb{<-} \hlkwd{ggplot}\hlstd{(RelEff.c,} \hlkwd{aes}\hlstd{(}\hlkwc{x}\hlstd{=p,} \hlkwc{y}\hlstd{=RelEff))}\hlopt{+}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{panelD} \hlkwb{<-} \hlkwd{ggplot}\hlstd{(RelEff.c,} \hlkwd{aes}\hlstd{(}\hlkwc{x}\hlstd{=p,} \hlkwc{y}\hlstd{=MVMAcomp))}\hlopt{+}
  \hlkwd{geom_point}\hlstd{(}\hlkwc{size}\hlstd{=}\hlnum{3.0}\hlstd{,} \hlkwd{aes}\hlstd{(}\hlkwc{color}\hlstd{=I,} \hlkwc{shape}\hlstd{=I))}\hlopt{+}
...
{\centering \includegraphics[width=\maxwidth]{figures/Figure_S5_panels_abcd-1} 
