...
setwd("/data/bocasm/Research/Meta analysis/code/simulations/cost_of_estimation_AR1_het")
...
MSEs <- expand.grid(I = 20, ##c(5, 10, 15, 20),
                    p = 2:10,
                    corrBtw = c(0.5),
                    varBtw = c(1/5, 1, 5))
...
##added in August 2016: also save Bayesian estimates
...
save(list=c("MSEs", "Vars",
     ...
     "OverallEstSigmaUniv"),
     file=paste("simResultsComb/combine_cost_of_estimation_AR1_het_",rowNr,".RData", sep=""))
